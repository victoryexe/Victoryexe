...
public class LogList {
    private static List<BannedAccountLog> bannedAccountLog = new LinkedList<>();
    private static List<DeletedAccountLog> deletedAccountLog = new LinkedList<>();
    ...
    private static List<UnblockAccountLog> unblockAccountLog = new LinkedList<>();
    ...
    public static List<BannedAccountLog> getBannedAccountLog() {
        return new LinkedList<BannedAccountLog>(bannedAccountLog);
    }
     ...
     */
    public static void makeBannedAccountEntry(Admin responsibleAccount, String bannedAccountID) {
        BannedAccountLog log = new BannedAccountLog(responsibleAccount, bannedAccountID);
     ...
     */
    public static void makeDeletedAccountEntry(Admin responsibleAccount, String deletedAccountID) {
        DeletedAccountLog log = new DeletedAccountLog(responsibleAccount, deletedAccountID);
     ...
     */
    public static void makeDeletedReportEntry(Manager responsibleAccount, Report report) {
     ...
     */
    public static void makeLoginAttemptEntry(Account responsibleAccount, boolean successStatus) {
        LoginAttemptLog log = new LoginAttemptLog(responsibleAccount, successStatus);
     ...
     */
    public static void makeUnblockAccountEntry(Admin responsibleAccount, String unblockedAccountID) {
        UnblockAccountLog log = new UnblockAccountLog(responsibleAccount, unblockedAccountID);
